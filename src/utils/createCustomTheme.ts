...
const createTheme = (): {
  ...
  /* Dark Styles */
  const baseColorDark = { h: 221, s: 20, l: 15 }
  const baseGreyColorDark = { h: 218, s: 18, l: 15 }
  ...
  const darkTheme: Theme = {
    ...lightTheme,
    baseBg: `radial-gradient(circle at top, ${greyDark[800]}, ${greyDark[1000]})`,
